...
<body>
	...
	<form id="checkout" action="checkout.php" method="post">
		<label>Number</label> <input data-braintree-name="number" value="4111111111111111"><br/>
		<label>Expiration date</label> <input data-braintree-name="expiration_date" value="10/20"><br/>
