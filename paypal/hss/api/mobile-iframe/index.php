...
<head>
  ...
  <title>PayPal - PayPal Hosted Solution (HSS) - mobile-iframe</title>
...
<body>
    <div class="page-header"><h1>PayPal Hosted Solution (HSS) <small>mobile-iframe</small></h1></div>
    <div class="panel panel-default">
      ...
      $request_params = array (
        ...
        'L_BUTTONVAR25' => 'cancel_return='.$webserver .'code/paypal/hss/api/templated/cancel.php', /* The browser will be redirected to this URL if the buyer clicks “Return to Merchant” link. Be sure to enter the complete URL, including http:// or https://. */
        ...
        'L_BUTTONVAR60' => 'template=mobile-iframe', /* PayPal landing page layout. Optional. default: templateA*/
        'L_BUTTONVAR61' => 'return='.$webserver .'code/paypal/hss/api/templated/success.php' /* The URL to which the buyer’s browser is redirected to after completing the payment. Be sure to enter the complete URL, including http:// or https://. */
        );
    ...
    */
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
        ...
        <iframe name="hss_iframe" width="600px" height="500px" src="<?php echo $paypal_url; ?>" ></iframe>
