...
<body>
    ...
    <div class="panel panel-default">
      ...
      $request_params = array (
        ...
        'L_BUTTONVAR60' => 'template=templateD', /* PayPal landing page layout. Optional. default: templateA*/
    ...
    */
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
        ...
        <iframe name="hss_iframe" width="650px" height="500px" src="<?php echo $paypal_url; ?>" ></iframe>
