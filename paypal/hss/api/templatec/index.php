...
<head>
  ...
  <title>PayPal - PayPal Hosted Solution (HSS) - templateC</title>
...
<body>
    <div class="page-header"><h1>PayPal Hosted Solution (HSS) <small>templateC</small></h1></div>
    ...
    <a href="https://developer.paypal.com/docs/classic/api/merchant/GetTransactionDetails_API_Operation_NVP/" target="_blank" class="list-group-item">GetTransactionDetails <i class="glyphicon glyphicon-minus pull-right"></i></a>
      ...
      #if ($_SERVER['REMOTE_ADDR']=='saavedrajj.com') { $var_return="http://saavedrajj.com/paypal/hss/api/templatea/success.html"; } else { $var_return="http://127.0.0.1:8080/paypal/hss/api/templatea/success.html"; }
      #if ($_SERVER['REMOTE_ADDR']=='saavedrajj.com') { $var_cancel_return="http://saavedrajj.com/paypal/hss/api/templatea/cancel.html"; } else { $var_cancel_return="http://127.0.0.1:8080/paypal/hss/api/templatea/cancel.html"; }
    ...
    // Store request params in an array
      ...
      (
        ...
        'L_BUTTONVAR25' => 'cancel_return='.$webserver .'code/paypal/hss/api/templatec/cancel.php', /* The browser will be redirected to this URL if the buyer clicks “Return to Merchant” link. Be sure to enter the complete URL, including http:// or https://. */
        ...
        'L_BUTTONVAR60' => 'template=templateC', /* PayPal landing page layout. Optional. default: templateA*/
        'L_BUTTONVAR61' => 'return='.$webserver .'code/paypal/hss/api/templatec/success.php' /* The URL to which the buyer’s browser is redirected to after completing the payment. Be sure to enter the complete URL, including http:// or https://. */
        );
