...
<head>
  ...
  <title>PayPal - PayPal Hosted Solution (HSS) - templateA</title>
...
<body>
    <div class="page-header"><h1>PayPal Hosted Solution (HSS) <small>templateA</small></h1></div>
    <div class="panel panel-default">
      ...
      $request_params = array (
        ...
        'L_BUTTONVAR25' => 'cancel_return='.$webserver .'code/paypal/hss/api/templatea/cancel.php', /* The browser will be redirected to this URL if the buyer clicks “Return to Merchant” link. Be sure to enter the complete URL, including http:// or https://. */
        ...
        'L_BUTTONVAR38' => 'cbt=Return to merchant', /* Footer text. Optional. default: Name of the account */
        ...
        'L_BUTTONVAR60' => 'template=templateA', /* PayPal landing page layout. Optional. default: templateA*/
        'L_BUTTONVAR61' => 'return='.$webserver .'code/paypal/hss/api/templatea/success.php' /* The URL to which the buyer’s browser is redirected to after completing the payment. Be sure to enter the complete URL, including http:// or https://. */
        );
