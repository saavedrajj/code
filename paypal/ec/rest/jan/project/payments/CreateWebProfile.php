...
$flowConfig->setBankTxnPendingUrl("$baseUrl/$startPageUrl?pending=bank");

// Parameters for style and presentation.
$presentation = new \PayPal\Api\Presentation();

// A URL to logo image. Allowed vaues: .gif, .jpg, or .png.
$presentation->setLogoImage("https://www.paypalobjects.com/webstatic/de_DE/i/de-pp-logo-100px.png")
//	A label that overrides the business name in the PayPal account on the PayPal pages.
    ->setBrandName("PayPal Plus Sample")
...
$webProfile->setName("PayPal Plus Sample" . uniqid())
