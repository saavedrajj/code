...
<head>
  ...
  <title>PayPal - Express Checkout Mark (ECM) Set + Do</title>
...
<body>
  ...
  'RETURNURL' => $webserver .'code/paypal/ec/nvp/ecm02/DoExpressCheckoutPayment.php?',
  'CANCELURL' => $webserver .'code/paypal/ec/nvp/ecm02/SetExpressCheckout.php',
...
?>
<div class="page-header"><h1>Express Checkout Mark <small>Set + Do</small></h1></div>
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      $paypal_url = "https://www.sandbox.paypal.com/webscr&cmd=_express-checkout&token=$token&useraction=commit";
      ?>
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item">Pay Now button: <a href="<?php echo $paypal_url; ?>" target="_blank"><?php echo $paypal_url; ?></a></li>
      </ul>
      <?php
    } else {
