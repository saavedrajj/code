...
<head>
  ...
  <title>PayPal - Express Checkout In-Context - Shortcut</title>
...
<body>
  ...
  'RETURNURL' => $webserver .'code/paypal/ec/nvp/in-context01/GetExpressCheckoutDetails.php',
  'CANCELURL' => $webserver .'code/paypal/ec/nvp/in-context01/SetExpressCheckout.php',
...
?>
<div class="page-header"><h1>Express Checkout In-Context <small>Shortcut</small></h1></div>
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      <form id="myContainer" method="post" action="https://www.sandbox.paypal.com/checkoutnow/?cmd=_express-checkout&token=<?php echo $token; ?>"></form>
      <script>
