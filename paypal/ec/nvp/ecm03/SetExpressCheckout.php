...
<head>
  ...
  <title>PayPal - Express Checkout Mark (ECM) Credit Card form displayed</title>
...
?>
<div class="page-header"><h1>Express Checkout Mark <small>Credit Card form displayed</small></h1></div>
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      ?>
      <p><?php require_once('../../../includes/items.html'); ?><a href="<?php echo $paypal_url."&force_sa=true"; ?>" target="_blank"><button type="button" class="btn btn-primary btn-lg">Pay with PayPal</button></a></p>
      <ul class="list-group">
