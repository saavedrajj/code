...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      ?>
      <ul class="list-group">
        <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/in-context02/DoExpressCheckoutPayment.php?&token=<?php echo $token; ?>&payerid=<?php echo $payerid; ?>"><button type="button" class="btn btn-primary btn-lg">Do Payment</button></a></li>
      </ul>
