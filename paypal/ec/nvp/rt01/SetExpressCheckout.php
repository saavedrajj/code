...
<head>
  ...
  <title>PayPal - Reference Transtractions - First payment with Express Checkout</title>
...
<body>
  ...
  'VERSION' => $api_version,
  'RETURNURL' => $webserver .'code/paypal/ec/nvp/rt01/GetExpressCheckoutDetails.php',
  'CANCELURL' => $webserver .'code/paypal/ec/nvp/rt01/SetExpressCheckout.php',
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      ?>
      <p><?php require_once('../../../includes/rt01.html'); ?><a href="<?php echo $paypal_url; ?>" target="_blank"><button type="button" class="btn btn-primary btn-lg">Pay with PayPal</button></a></p>
      <ul class="list-group">
