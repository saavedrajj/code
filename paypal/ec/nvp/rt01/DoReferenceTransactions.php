...
<body>
  ...
  'REFERENCEID' => $referenceid  #Billing agreement ID received in the DoExpressCheckoutPayment call
);
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <div class="list-group">
      ...
      <a href="https://developer.paypal.com/docs/classic/api/merchant/DoReferenceTransaction_API_Operation_NVP/" target="_blank" class="list-group-item active">DoReferenceTransactions <i class="glyphicon glyphicon-ok pull-right"></i></a>
      <a href="https://developer.paypal.com/docs/classic/api/merchant/BAUpdate_API_Operation_NVP/" target="_blank" class="list-group-item">BillAgreementUpdate <i class="glyphicon glyphicon-minus pull-right"></i></a>
    </div>
    <?php
    ...
    <ul class="list-group">
      ...
      <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/rt01/BillAgreementUpdate.php?&referenceid=<?php echo $referenceid; ?>"><button type="button" class="btn btn-primary btn-lg">Cancel Billing Agreement</button></a></li>
    </ul>
