...
?>
<div class="page-header"><h1>Recurring Payments <small>First payment with Express Checkout</small></h1></div>
<div class="panel panel-default">
  ...
  <div class="panel-body">
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      <ul class="list-group">
        <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/rp03/CreateRecurringPaymentsProfile.php?&token=<?php echo $token; ?>&payerid=<?php echo $payerid; ?>"><button type="button" class="btn btn-primary btn-lg">Create Recurring Payments Profile</button></a></li>
      </ul>
