...
<body>
  ...
  # 'MAXAMT' => '', Only for orders
    'RETURNURL' => $webserver .'code/paypal/ec/nvp/ord-auth-capt/GetExpressCheckoutDetails.php',
    'CANCELURL' => $webserver .'code/paypal/ec/nvp/ord-auth-capt/SetExpressCheckout.php',

  ## CALLBACK / CALLBACKTIMEOUT / CALLBACKVERSION
    'EMAIL' => 'es_personal@saavedrajj.com',
    /* Type */
  'PAYMENTREQUEST_0_PAYMENTACTION' => 'Order', #Authorization ¦ Order
...
<div class="panel panel-default">
  ...
  <div class="panel-body">
    <div class="list-group">
      ...
      <a href="https://developer.paypal.com/docs/classic/api/merchant/DoAuthorization_API_Operation_NVP/" target="_blank" class="list-group-item">DoAuthorization 2<i class="glyphicon glyphicon-minus pull-right"></i></a>
    ...
    if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
      ...
      ?>
      <p><?php require_once('../../../includes/items.html'); ?><a href="<?php echo $paypal_url; ?>" target="_blank"><button type="button" class="btn btn-primary btn-lg">Pay with PayPal</button></a></p>
      <ul class="list-group">
        <li class="list-group-item">API response: <a href="<?php echo $paypal_url ?>" target="_blank"><?php echo $paypal_url ?></a></li>
        <li class="list-group-item">Classic Interface: <a href="<?php echo $paypal_url."&force_sa=true" ?>" targer="_blank"><?php echo $paypal_url."&force_sa=true" ?></a></li>
      </ul>
      <?php
    } else {
...
<div class="bs-example">
    <div class="panel-group" id="accordion">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne">Response</a>
                </h4>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">
                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo">Request</a>
                </h4>
            </div>
