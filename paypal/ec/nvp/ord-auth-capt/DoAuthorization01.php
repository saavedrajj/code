...
<body>
  ...
  $orderauthorizationid = $transactionid;
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      <div class="list-group">
        ...
        <a href="https://developer.paypal.com/docs/classic/api/merchant/DoAuthorization_API_Operation_NVP/" target="_blank" class="list-group-item active">DoAuthorization 1<i class="glyphicon glyphicon-ok pull-right"></i></a>
      ...
      if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
        ...
        <ul class="list-group">
          <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/ord-auth-capt/DoCapture01.php?&transactionid=<?php echo $transactionid; ?>&orderauthorizationid=<?php echo $orderauthorizationid; ?>"><button type="button" class="btn btn-primary btn-lg">Do Capture 1</button></a></li>
        </ul>
        <?php
      } else {
        ?>
