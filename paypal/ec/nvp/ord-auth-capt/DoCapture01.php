...
<body>
  ...
  $orderauthorizationid = $_GET['orderauthorizationid'];
...
<div class="page-header"><h1>Order + Authorization + Capture<small></small></h1></div>
  <div class="panel panel-default">
    <div class="panel-heading">
      <h3 class="panel-title">DoCapture API</h3>
    </div>
    <div class="panel-body">
      <div class="list-group">
        ...
        <a href="https://developer.paypal.com/docs/classic/api/merchant/DoCapture_API_Operation_NVP/" target="_blank" class="list-group-item active">DoCapture 1<i class="glyphicon glyphicon-ok pull-right"></i></a>
      ...
      if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
        ...
        <?php
        $transactionid = urldecode($result_array["AUTHORIZATIONID"]);
        ?>
        <ul class="list-group">
          <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/ord-auth-capt/DoAuthorization02.php?&transactionid=<?php echo $orderauthorizationid; ?>"><button type="button" class="btn btn-primary btn-lg">Do Authorization 2</button></a></li>
        </ul>
