  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body">
      ...
      if ("SUCCESS" == strtoupper($result_array["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($result_array["ACK"])) {
        ...
        <ul class="list-group">
          <li class="list-group-item"><a href="<?php echo $webserver; ?>code/paypal/ec/nvp/ord-auth-capt/DoAuthorization01.php?&transactionid=<?php echo $transactionid; ?>"><button type="button" class="btn btn-primary btn-lg">Do Authorization 1</button></a></li>
        </ul>
        <?php
      } else {
        ?>
