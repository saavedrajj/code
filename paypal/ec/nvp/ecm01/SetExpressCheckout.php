...
<head>
  ...
  <title>PayPal - Express Checkout Mark (ECM) Set + Get + Do</title>
...
<body>
  ...
  # 'MAXAMT' => '', Only for orders
    'RETURNURL' => $webserver .'code/paypal/ec/nvp/ecm01/GetExpressCheckoutDetails.php',
    'CANCELURL' => $webserver .'code/paypal/ec/nvp/ecm01/SetExpressCheckout.php',
...
?>
<div class="page-header"><h1>Express Checkout Mark <small>Set + Get + Do</small></h1></div>
